...
export declare function nice(scaleType: ScaleType, channel: ScaleChannel, specifiedDomain: Domain, fieldOrDatumDef: TypedFieldDef<string> | ScaleDatumDef): boolean | TimeInterval;
